...
namespace CA_assignment_part_2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            StreamReader read_from_txt = new StreamReader(@"C:\Users\Lucas.L.H.H\Desktop\Computer Architechture Assignment\CA_assignment_part_1\H.V.L.Hasanka(10026404).txt");
